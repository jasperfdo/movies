...
!function (D, u) {
  ...
  function s(D, u) {
    var e;
    return d(D) ? D : "string" == (e = _typeof(D)) && !u && D ? a.call(X.querySelectorAll(D), 0) : D && "object" == e && "length" in D ? a.call(D, 0) : D ? [D] : [];
  }
  ...
  function A(D) {
    ...
    for (u = 0; u < F; u++) {
      (e = t[u])._isSplit ? A(e) : u && e.previousSibling && 3 === e.previousSibling.nodeType ? (e.previousSibling.nodeValue += 3 === e.nodeType ? e.nodeValue : e.firstChild.nodeValue, D.removeChild(e)) : 3 !== e.nodeType && (D.insertBefore(e.firstChild, e), D.removeChild(e));
    }
  }
  ...
  function C(D, u, e, F, i, C, n) {
    var s,
        ...
        L = B("fontSize", _) * (u.lineThreshold || .2),
        W = _.textAlign,
        O = [],
        H = [],
        V = [],
    ...
    for (J && (I = I.split("++").join("")), Q && (D.style.display = "block"), r = (E = D.getElementsByTagName("*")).length, o = [], s = 0; s < r; s++) {
      o[s] = E[s];
    }

    if (k || G) for (s = 0; s < r; s++) {
      ((d = (l = o[s]).parentNode === D) || G || q && !P) && (m = l.offsetTop, k && d && Math.abs(m - w) > L && ("BR" !== l.nodeName || 0 === s) && (a = [], k.push(a), w = m), G && (l._x = l.offsetLeft, l._y = m, l._w = l.offsetWidth, l._h = l.offsetHeight), k && ((l._isSplit && d || !q && d || P && d || !P && l.parentNode.parentNode === D && !l.parentNode._isSplit) && (a.push(l), l._x -= v, z(l, D, j) && (l._wordEnd = !0)), "BR" === l.nodeName && (l.nextSibling && "BR" === l.nextSibling.nodeName || 0 === s) && k.push([])));
    }
    ...
    for (s = 0; s < r; s++) {
      if (d = (l = o[s]).parentNode === D, "BR" !== l.nodeName) {
        if (G && (f = l.style, P || d || (l._x += l.parentNode._x, l._y += l.parentNode._y), f.left = l._x + "px", f.top = l._y + "px", f.position = "absolute", f.display = "block", f.width = l._w + 1 + "px", f.height = l._h + "px"), !P && q) {
          if (l._isSplit) for (l._next = E = l.nextSibling, l.parentNode.appendChild(l); E && 3 === E.nodeType && " " === E.textContent;) {
            l._next = E.nextSibling, l.parentNode.appendChild(E), E = E.nextSibling;
          } else l.parentNode._isSplit ? (l._parent = l.parentNode, !l.previousSibling && l.firstChild && (l.firstChild._isFirst = !0), l.nextSibling && " " === l.nextSibling.textContent && !l.nextSibling.nextSibling && K.push(l.nextSibling), l._next = l.nextSibling && l.nextSibling._isFirst ? null : l.nextSibling, l.parentNode.removeChild(l), o.splice(s--, 1), r--) : d || (m = !l.nextSibling && z(l.parentNode, D, j), l.parentNode._parent && l.parentNode._parent.appendChild(l), m && l.parentNode.appendChild(X.createTextNode(" ")), "span" === M && (l.style.display = "inline"), O.push(l));
        } else l.parentNode._isSplit && !l._isSplit && "" !== l.innerHTML ? H.push(l) : q && !l._isSplit && ("span" === M && (l.style.display = "inline"), O.push(l));
      } else k || G ? (l.parentNode && l.parentNode.removeChild(l), o.splice(s--, 1), r--) : P || D.appendChild(l);
    }
    ...
    if (k) {
      for (G && (c = X.createElement(M), D.appendChild(c), g = c.offsetWidth + "px", m = c.offsetParent === D ? 0 : D.offsetLeft, D.removeChild(c)), f = D.style.cssText, D.style.cssText = "display:none;"; D.firstChild;) {
        D.removeChild(D.firstChild);
      }

      for (h = " " === j && (!G || !P && !q), s = 0; s < k.length; s++) {
        for (a = k[s], (c = X.createElement(M)).style.cssText = "display:block;text-align:" + W + ";position:" + (G ? "absolute;" : "relative;"), I && (c.className = I + (J ? s + 1 : "")), V.push(c), r = a.length, E = 0; E < r; E++) {
          "BR" !== a[E].nodeName && (l = a[E], c.appendChild(l), h && l._wordEnd && c.appendChild(X.createTextNode(" ")), G && (0 === E && (c.style.top = l._y + "px", c.style.left = v + m + "px"), l.style.top = "0px", m && (l.style.left = l._x - m + "px")));
        }
    ...
    G && (n > D.clientHeight && (D.style.height = n - T + "px", D.clientHeight < n && (D.style.height = n + b + "px")), C > D.clientWidth && (D.style.width = C - N + "px", D.clientWidth < C && (D.style.width = C + S + "px"))), Q && (U ? D.style.display = U : D.style.removeProperty("display")), y(e, O), P && y(F, H), y(i, V);
  }
  ...
  function D(D, e, F, i) {
    ...
    for (y.insertBefore(m, D), m.textContent = D.nodeValue, y.removeChild(D), o = -1 !== (C = function getText(D) {
      var u = D.nodeType,
          e = "";
      ...
      return e;
    }(D = m)).indexOf("<"), !1 !== e.reduceWhiteSpace && (C = C.replace(b, " ").replace(v, "")), o && (C = C.split("<").join("{{LT}}")), r = C.length, n = (" " === C.charAt(0) ? f : "") + F(), s = 0; s < r; s++) {
      if (l = C.charAt(s), g && (d = g(C.substr(s), e.specialChars))) l = C.substr(s, d || 1), n += p && " " !== l ? i() + l + "</" + a + ">" : l, s += d - 1;else if (l === B && C.charAt(s - 1) !== B && s) {
        for (n += c ? A : "", c = 0; C.charAt(s + 1) === B;) {
          n += f, s++;
        }

        s === r - 1 ? n += f : ")" !== C.charAt(s + 1) && (n += f + F(), c = 1);
      } else "{" === l && "{{LT}}" === C.substr(s, 6) ? (n += p ? i() + "{{LT}}</" + a + ">" : "{{LT}}", s += 5) : 55296 <= l.charCodeAt(0) && l.charCodeAt(0) <= 56319 || 65024 <= C.charCodeAt(s + 1) && C.charCodeAt(s + 1) <= 65039 ? (E = ((C.substr(s, 12).split(_) || [])[1] || "").length || 2, n += p && " " !== l ? i() + C.substr(s, E) + "</" + a + ">" : C.substr(s, E), s += E - 1) : n += p && " " !== l ? i() + l + "</" + a + ">" : l;
    }
  ...
  function E(u, e, F, i) {
    ...
    if (3 !== u.nodeType || 1 < l) {
      for (e.absolute = !1, C = 0; C < l; C++) {
        (n = r[C])._next = n._isFirst = n._parent = n._wordEnd = null, 3 === n.nodeType && !/\S+/.test(n.nodeValue) || (o && 3 !== n.nodeType && "inline" === p(n).display && (n.style.display = "inline-block", n.style.position = "relative"), n._isSplit = !0, E(n, e, F, i));
      }
  ...
  var X,
      ...
      o = function (D) {
    var u = 0 === (window ? window.location.href : "").indexOf(m(102, 105, 108, 101, 58, 47, 47)) || -1 !== D.indexOf(m(108, 111, 99, 97, 108, 104, 111, 115, 116)) || -1 !== D.indexOf(m(49, 50, 55, 46, 48, 32, 48, 46, 49)),
