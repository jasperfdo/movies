...
})({"gXp5O":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
...
class Slider {
    ...
    setup() {
        ...
        const { width: wrapWidth , left: wrapDiff  } = this.el.getBoundingClientRect(); // Set bounding
        ...
        for(let i = 0; i < items.length; i++){
            const el = items[i];
            const { left , right , width  } = el.getBoundingClientRect(); // Create webgl plane
...
},{}]},["gXp5O","9kpAy"], "9kpAy", "parcelRequire3e9f")
